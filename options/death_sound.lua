...
variables_loaded_frame:SetScript("OnEvent", function(self, event)
    if event == "VARIABLES_LOADED" then
        ...
        death_sound_check_box:SetDescription("If not enabled, no death sound will play on player death.")
        ...
        death_sound_custom_check_box:SetDescription("If not allowed, the default death sound will play on every player death.")
        death_sound_check_box:SetValue(AMENOVARS.allow_custom_death_sounds)
        death_sound_custom_check_box:SetCallback("OnValueChanged", function()
            AMENOVARS.allow_custom_death_sounds = death_sound_custom_check_box:GetValue()
        end)
