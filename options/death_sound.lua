...
variables_loaded_frame:SetScript("OnEvent", function(self, event)
    if event == "VARIABLES_LOADED" then
        ...
        death_sound_check_box:SetDescription("If not allowed, no death sound will play on player death.")
        ...
        death_sound_custom_check_box:SetDescription("If not allowed, the default death sound will play on player death.")
